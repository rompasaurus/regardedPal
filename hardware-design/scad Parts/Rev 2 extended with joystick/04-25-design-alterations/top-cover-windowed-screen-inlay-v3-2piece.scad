// Dilder Rev 2 "extended with joystick" — TOP COVER v3, 2-PIECE (no middle platform)
//
// Forked from top-cover-windowed-screen-inlay-v2-46y.scad. The only
...
//   7.7 ────────── face plate top (0.7 mm face plate)
//   11.7 ─────── bullnose top — cover total height
//
...
//
// Export:
//   openscad -o top-cover-windowed-screen-inlay-v3-2piece.3mf top-cover-windowed-screen-inlay-v3-2piece.scad
