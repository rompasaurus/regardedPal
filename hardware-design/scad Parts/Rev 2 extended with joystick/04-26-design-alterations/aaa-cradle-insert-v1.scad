// Dilder Rev 2 "extended with joystick" — AAA CRADLE INSERT v2
//
// Based on the 04-24 v1 cradle insert, extended to fit the 94.5 mm wide
// enclosure (+3 mm on -X for TP4056 charge board).
//
// Changes from v1:
//   - enclosure_outer_width_along_x_axis_mm: 91.5 → 94.5
//   - Connecting block extended to 29 mm X / full plug height for TP4056
//   - 1 mm TP4056 indent on the connecting block's top face
//   - Concave battery-following arcs on the connecting block's ±Y faces
//   - +X display connector cutout (3 mm from bottom face)
//   - No USB-C port cutout (board accessible from the open Pico nest)
//
// Export:
