// Dilder Top-Mid Plate (solid) — display cover plate with snap-fit rails, no window
//
...
// This variant has NO viewing window — use top-plate-windowed.scad for that.
//
// Export:
//   openscad -o top-plate-solid.3mf top-plate-solid.scad
